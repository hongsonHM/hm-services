...
/**
 * Criteria class for the {@link com.overnetcontact.dvvs.domain.SvcSchedulePlanRecord} entity. This class is used
 * in {@link com.overnetcontact.dvvs.web.rest.SvcSchedulePlanRecordResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /svc-schedule-plan-records?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class SvcSchedulePlanRecordCriteria implements Serializable, Criteria {

    private static final long serialVersionUID = 1L;

    private LongFilter id;

    private IntegerFilter svcSchedulePlanId;
    ...
    private LongFilter svcScheduleUnitRecordId;

    public SvcSchedulePlanRecordCriteria() {}

    public SvcSchedulePlanRecordCriteria(SvcSchedulePlanRecordCriteria other) {
        this.id = other.id == null ? null : other.id.copy();
        this.svcSchedulePlanId = other.svcSchedulePlanId == null ? null : other.svcSchedulePlanId.copy();
        ...
        this.svcScheduleUnitRecordId = other.svcScheduleUnitRecordId == null ? null : other.svcScheduleUnitRecordId.copy();
    }

    @Override
    public SvcSchedulePlanRecordCriteria copy() {
        return new SvcSchedulePlanRecordCriteria(this);
    }
    ...
    public IntegerFilter getSvcSchedulePlanId() {
        return svcSchedulePlanId;
    }

    public IntegerFilter svcSchedulePlanId() {
        if (svcSchedulePlanId == null) {
            svcSchedulePlanId = new IntegerFilter();
        }
        return svcSchedulePlanId;
    }

    public void setSvcSchedulePlanId(IntegerFilter svcSchedulePlanId) {
    ...
    public LongFilter getSvcScheduleUnitRecordId() {
        return svcScheduleUnitRecordId;
    }

    public LongFilter svcScheduleUnitRecordId() {
        if (svcScheduleUnitRecordId == null) {
            svcScheduleUnitRecordId = new LongFilter();
        }
        return svcScheduleUnitRecordId;
    }

    public void setSvcScheduleUnitRecordId(LongFilter svcScheduleUnitRecordId) {
        this.svcScheduleUnitRecordId = svcScheduleUnitRecordId;
    }
    ...
    public boolean equals(Object o) {
        ...
        final SvcSchedulePlanRecordCriteria that = (SvcSchedulePlanRecordCriteria) o;
        return (
            Objects.equals(id, that.id) &&
            Objects.equals(svcSchedulePlanId, that.svcSchedulePlanId) &&
            ...
            Objects.equals(svcScheduleUnitRecordId, that.svcScheduleUnitRecordId)
        );
    }
    ...
    public String toString() {
        return "SvcSchedulePlanRecordCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
            (svcSchedulePlanId != null ? "svcSchedulePlanId=" + svcSchedulePlanId + ", " : "") +
            ...
            (svcScheduleUnitRecordId != null ? "svcScheduleUnitRecordId=" + svcScheduleUnitRecordId + ", " : "") +
            "}";
    }
}
