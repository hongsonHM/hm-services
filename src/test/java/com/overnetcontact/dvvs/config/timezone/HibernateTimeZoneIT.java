package com.overnetcontact.dvvs.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import com.overnetcontact.dvvs.IntegrationTest;
import com.overnetcontact.dvvs.repository.timezone.DateTimeWrapper;
import com.overnetcontact.dvvs.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM dvvs_date_time_wrapper where id=%d", fieldName, id);
    }
