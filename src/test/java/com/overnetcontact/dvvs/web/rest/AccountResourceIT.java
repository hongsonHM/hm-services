...
import static com.overnetcontact.dvvs.web.rest.AccountResourceIT.TEST_USER_LOGIN;
import static org.assertj.core.api.Assertions.assertThat;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import com.overnetcontact.dvvs.IntegrationTest;
import com.overnetcontact.dvvs.config.Constants;
import com.overnetcontact.dvvs.domain.User;
import com.overnetcontact.dvvs.repository.AuthorityRepository;
import com.overnetcontact.dvvs.repository.UserRepository;
import com.overnetcontact.dvvs.security.AuthoritiesConstants;
import com.overnetcontact.dvvs.service.UserService;
import com.overnetcontact.dvvs.service.dto.AdminUserDTO;
import com.overnetcontact.dvvs.service.dto.PasswordChangeDTO;
import com.overnetcontact.dvvs.service.dto.UserDTO;
import com.overnetcontact.dvvs.web.rest.vm.KeyAndPasswordVM;
import com.overnetcontact.dvvs.web.rest.vm.ManagedUserVM;
...
class AccountResourceIT {
    ...
    void testGetExistingAccount() throws Exception {
        ...
        authorities.add(AuthoritiesConstants.BUSINESS_MANAGER);
        ...
        restAccountMockMvc
            ...
            .andExpect(jsonPath("$.authorities").value(AuthoritiesConstants.BUSINESS_MANAGER));
    }
    ...
    void testRegisterValid() throws Exception {
        ...
        validUser.setAuthorities(Collections.singleton(AuthoritiesConstants.BUSINESS_STAFF));
    ...
    void testRegisterInvalidLogin() throws Exception {
        ...
        invalidUser.setAuthorities(Collections.singleton(AuthoritiesConstants.BUSINESS_STAFF));
    ...
    void testRegisterDuplicateLogin() throws Exception {
        ...
        firstUser.setAuthorities(Collections.singleton(AuthoritiesConstants.BUSINESS_STAFF));
    ...
    void testRegisterAdminIsIgnored() throws Exception {
        ...
        validUser.setImageUrl("http://placehold.it/50x50");
        validUser.setLangKey(Constants.DEFAULT_LANGUAGE);
        validUser.setAuthorities(Collections.singleton(AuthoritiesConstants.BUSINESS_MANAGER));
        ...
        assertThat(userDup.get().getAuthorities())
            .hasSize(1)
            .containsExactly(authorityRepository.findById(AuthoritiesConstants.BUSINESS_STAFF).get());
    }
    ...
    void testSaveAccount() throws Exception {
        ...
        userDTO.setAuthorities(Collections.singleton(AuthoritiesConstants.BUSINESS_MANAGER));
